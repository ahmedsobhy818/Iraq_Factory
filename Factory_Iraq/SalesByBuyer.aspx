<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SalesByBuyer.aspx.cs" Inherits="Factory_Iraq.SalesByBuyer" %>
...
@media (max-width:640px){
    ...
    <h1>تقرير المبيعات حسب المشترى</h1>

    <div class="item" >
        <span style="line-height:33px;margin-left:80px">اسم المشترى</span>
    </div>

    <div class="item" style="min-width:300px">
        <asp:DropDownList ID="cmbBuyers" runat="server" Width="200px" CssClass="form-control"  ></asp:DropDownList>
    </div>
  ...
  <div class="item"  >
    ...
    <script>
        ...
        function PrintRepeater1() {
            ...
            printWindow.document.write('<html dir=rtl><head><style>table{text-align:center} div.item{ float:right;  margin:10px;  }   div.item div{ float:right;  margin-left:5px; }  .goLeft{  float:left !important }</style><title>تقرير المبيعات حسب المشترى</title>');
