<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="InventoryByMaterialMark.aspx.cs" Inherits="Factory_Iraq.InventoryByMaterialMark" %>
...
<h1>جرد المخزن حسب الماركات</h1>
    
        <div class="item">
        <div style="line-height:33px">ماركة : </div>
            <div>
            <asp:UpdatePanel runat="server">
                <ContentTemplate>
                    <asp:DropDownList ID="cmbMaterialMark" runat="server"  Width="264px" AutoPostBack="True" OnSelectedIndexChanged="cmbMaterialMark_SelectedIndexChanged" CssClass="form-control">
                </asp:DropDownList>
                </ContentTemplate>
            </asp:UpdatePanel>
    ...
    <script>
        ...
        function PrintRepeater() {
            ...
            printWindow.document.write('<html dir=rtl><head><style>table{text-align:center}</style><title>جرد المخزن حسب الماركات</title>');
