...
{
    public partial class SalesByBuyer : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                conn.Open();
                SqlCommand commp = new SqlCommand("SELECT [c_name] FROM[custumer]" , conn);
