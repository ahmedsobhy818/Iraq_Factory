<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SalesByMaterial.aspx.cs" Inherits="Factory_Iraq.SalesByMaterial" %>
...
@media (max-width:640px){
    ...
    <h1>تقرير المبيعات حسب المادة</h1>

    <div class="item" >
        <span style="line-height:33px;margin-left:380px">جميع المواد</span>
    </div>
    <div class="item"  >
  ...
  <div class="item"  >
    ...
    <script>
        ...
        function PrintRepeater1() {
            ...
            printWindow.document.write('<html dir=rtl><head><style>table{text-align:center} div.item{ float:right;  margin:10px;  }   div.item div{ float:right;  margin-left:5px; }  .goLeft{  float:left !important }</style><title>تقرير المبيعات حسب المادة</title>');
        ...
        function doFilter() {
            ...
            $('div.item').eq(7).find('.lblTotal').text(total.toFixed(2) + "$");
        }
    </script>
    </div>
</asp:Content>
