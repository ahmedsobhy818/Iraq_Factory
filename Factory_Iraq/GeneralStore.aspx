<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="GeneralStore.aspx.cs" Inherits="Factory_Iraq.GeneralStore" %>
...
@media (max-width:640px){
    ...
    <div class="item"  >
     ...
     <ItemTemplate>
            <tr>
                ...
                <td style="width: 30%">
                    <asp:Label ID="Label2" runat="server" Text='<%# Eval("كمية") %>' />
                </td>
    ...
    <script>
        ...
        function PrintRepeater1() {
            ...
            printWindow.document.write('<html dir=rtl><head><style>table{text-align:center} div.item{ float:right;  margin:10px;  }   div.item div{ float:right;  margin-left:5px; }  .goLeft{  float:left !important } .tablesaw-cell-label{display:none !important}</style><title>مخزن عام</title>');
